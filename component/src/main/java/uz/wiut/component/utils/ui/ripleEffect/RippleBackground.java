package uz.wiut.component.utils.ui.ripleEffect;
...
public class RippleBackground extends RelativeLayout{
    ...
    private void init(final Context context, final AttributeSet attrs) {
        ...
        final TypedArray typedArray = context.getTheme().obtainStyledAttributes(attrs, R.styleable.RippleBackground, 0, 0);
    ...
    public void setViewLocation(int locaiton){
        rippleParams.addRule(locaiton, TRUE);
    }
